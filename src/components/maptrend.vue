<template>
  <div class="vue_charts">
    <div class="box">
      <div class="titleleft">迁徙趋势地图</div>
      <div id="main" style=""></div>
      <div class="application">
        <p>应用场景：统计分析我国人口的迁徙趋势及人数</p>
        <p>展示效果：如上图</p>
...
export default {
  ...
  methods: {
    drawLine () {
      ...
      var convertData1 = function (data) {
        ...
        for (var i = 0; i < data.length; i++) {
          ...
          if (fromCoord1 && toCoord1) {
            res1.push({
              fromName: dataItem1[0].name,
              toName: dataItem1[1].name,
              coords: [fromCoord1, toCoord1],
              value: dataItem1[1].value
            })
          }
        }
        return res1
      ...
      var series1 = [];
      [['北京', BJData1], ['上海', SHData1], ['广州', GZData1]].forEach(
        function (item, i) {
          series1.push(
            {
              name: item[0] + ' Top10',
            ...
            },
            {
              ...
              data: item[1].map(function (dataItem) {
                return {
                  name: dataItem1[1].name,
                  value: geoCoordMap1[dataItem1[1].name].concat([
                    dataItem1[1].value
                  ])
                }
              })
